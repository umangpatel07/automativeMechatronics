                ...
                <div class="col-lg-12">
                    ...
                    <div class="col-sm-6">
                                <div class="form-group">
                                    <input value="<?php echo $_SESSION['email']; ?>" class="form-control valid" name="email" id="email" type="hidden" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Enter email address'" placeholder="Email">
                                </div>
                            </div>
                            <div class="col-sm-12">
                                <div class="form-group">
...
if(isset($_SESSION['email'])) {
    ?>
                            ...
                            ?>
                            <center><h1 style="margin-bottom:30px; color:red;">Please Login For Getting Touch With Us</h1><a href="log.php" class="btn">log in</a></center>
                            <?php
}
                            ?>
                        </div>
...
if(isset($_POST['submit']))
{
    ...
    $insert_data="INSERT INTO contactus(name,email,subject,message) VALUES('$name','$email','$subject','$message')";
